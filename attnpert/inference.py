...
def evaluate(loader, model, uncertainty, device, real_num_genes = None):
    """
...
#This evaluation is just as test. IT HAS INFORMATION LEAKAGE!
def evaluate_with_nonzero_mask(loader, model, uncertainty, device):
    """
    Run model in inference mode using a given data loader
    """
...
def non_zero_evaluate(loader, model, uncertainty, device, 
                        delta_list, penalty = {
                            "false_neg": 1,
                            "false_pos": 1 }):
    """
